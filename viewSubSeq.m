function viewSubSeq(h, vs, f0s, sigs, Qs, bases, noises, vlim, vlabel, siglabel, plotType, specs)
...
%     plot(vs, f0s./1e6, specs{1}, 'MarkerSize',12, 'LineWidth',4);
    plot(vs, (f0s(1)-f0s)./f0s(1), specs{1}, 'MarkerSize',12, 'LineWidth',4);
    xlabel(vlabel);
    xlim(vlim);
%     ylabel('f0 [MHz]');
    ylabel('\Deltaf/f_0 [MHz]');
    hold on;
    subplot(h{2});
